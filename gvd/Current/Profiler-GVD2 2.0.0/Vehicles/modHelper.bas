...
If bResponsive Then
     TotalSpecialCost = ResponsiveCost
End If
If bRobotic Then
     TotalSpecialCost = TotalSpecialCost * RoboticCost
End If
If bBiomechanical Then
     TotalSpecialCost = TotalSpecialCost * BiomechanicalCost
End If
If bLivingMetal Then
     TotalSpecialCost = TotalSpecialCost * LivingMetalCost
End If
...
If bSubmersible Then
     TotalOtherCost = 2
End If
If bWingsorRotors Then
     TotalOtherCost = TotalOtherCost * 10
End If
If bLiftingBody Then
     TotalOtherCost = TotalOtherCost * 1.2
End If
If bFlexibody Then
     TotalOtherCost = TotalOtherCost * 2
End If
...
If bSubmersible Then
     TotalOtherWeight = SubmersibleCost
End If
If bFlexibody Then
     TotalOtherWeight = TotalOtherWeight * FlexibodyCost
End If
