...
retry:
    ...
    pds.Name = "GVD.exe" & Chr(0)
    pds.Vbp = "C:\Documents and Settings\Administrator\My Documents\dev\vb\projects\gvd\Current\Profiler-GVD2 2.0.0\GVD2\Designer.vbp" & Chr(0)
    ...
    pds.IniFile = "C:\Documents and Settings\Administrator\My Documents\dev\vb\projects\gvd\Current\vbw2Options_GVD2.ini" & Chr(0)
    pds.AppMajor = App.Major
    pds.AppMinor = App.Minor
    pds.AppRev = App.Revision
    pds.LinesNumber = CLng("11519")
    pds.ProceduresNumber = CLng("638")
