...
retry:
    ...
    pds.Name = "PersistenceManager.dll" & Chr(0)
    pds.Vbp = "C:\Documents and Settings\Administrator\My Documents\dev\vb\projects\gvd\Current\Profiler-GVD2 2.0.0\PersistenceManager\PersistenceManager.vbp" & Chr(0)
    pds.Vbg = "C:\Documents and Settings\Administrator\My Documents\dev\vb\projects\gvd\Current\Profiler-GVD2 2.0.0\GVD2.vbg" & Chr(0)
    pds.IniFile = "C:\Documents and Settings\Administrator\My Documents\dev\vb\projects\XML Persistance\vbw2Options_PersistenceManager.ini" & Chr(0)
    pds.AppMajor = App.Major
    pds.AppMinor = App.Minor
    pds.AppRev = App.Revision
    pds.LinesNumber = CLng("383")
    pds.ProceduresNumber = CLng("27")
