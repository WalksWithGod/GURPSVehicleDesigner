Option Strict Off
Option Explicit On
<System.Runtime.InteropServices.ProgId("clsTrack_NET.clsTrack")> Public Class clsTrack
	...
	Public Function LocationCheck() As Boolean
		...
		If InstallPoint = Body Then
			TempCheck = True
		Else
			modHelper.InfoPrint(1, "Tracks must be placed on hull.")
			TempCheck = False
		End If
	...
	Public Sub StatsUpdate()
		...
		' Calculate the  volume using Track specific rules
		...
		If mvarSubType = "tracks" Then
			'UPGRADE_WARNING: Couldn't resolve default property of object Veh.Components. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
			mvarVolume = System.Math.Round(Veh.Components(BODY_KEY).Volume * 0.6, 2)
		Else
			'UPGRADE_WARNING: Couldn't resolve default property of object Veh.Components. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
			mvarVolume = System.Math.Round(Veh.Components(BODY_KEY).Volume * 0.4, 2)
		End If
		...
		mvarPrintOutput = mvarCustomDescription & " (" & VB6.Format(mvarQuantity) & " tracks)."
