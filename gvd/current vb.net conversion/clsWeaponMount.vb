Option Strict Off
Option Explicit On
<System.Runtime.InteropServices.ProgId("clsWeaponMount_NET.clsWeaponMount")> Public Class clsWeaponMount
	...
	Function LocationCheck() As Boolean
		...
		If TypeOf Veh.Components(Parent) Is clsWeaponBeam Then
			TempCheck = True
			'UPGRADE_WARNING: Couldn't resolve default property of object Veh.Components. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
		ElseIf TypeOf Veh.Components(Parent) Is clsWeaponGun Then 
			TempCheck = True
			'UPGRADE_WARNING: Couldn't resolve default property of object Veh.Components. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
		ElseIf TypeOf Veh.Components(Parent) Is clsWeaponLauncher Then 
			TempCheck = True
			'UPGRADE_WARNING: Couldn't resolve default property of object Veh.Components. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
		ElseIf TypeOf Veh.Components(Parent) Is clsWeaponLiquidProjector Then 
			TempCheck = True
		Else
			TempCheck = False
			modHelper.InfoPrint(1, "Weapon Mounts must be attached to valid Guns, Launchers, Liquid Projectors or Beam Weapons.")
		End If
