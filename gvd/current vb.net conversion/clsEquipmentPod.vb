Option Strict Off
Option Explicit On
<System.Runtime.InteropServices.ProgId("clsEquipmentPod_NET.clsEquipmentPod")> Public Class clsEquipmentPod
	...
	Public Sub StatsUpdate()
		...
		'UPGRADE_WARNING: Couldn't resolve default property of object Veh.Components. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
		mvarPrintOutput = NumericToString(mvarQuantity) & " " & mvarCustomDescription & sPrintPlural1 & " " & " (" & Veh.Components(mvarParent).Abbrev + ")."
	...
	Public Function LocationCheck() As Boolean
		...
		If InstallPoint = HardPoint Then
			TempCheck = True
		Else
			modHelper.InfoPrint(1, "equipment Pods must be attached to Hardpoints.")
			TempCheck = False
		End If
