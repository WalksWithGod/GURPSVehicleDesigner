Option Strict Off
Option Explicit On
<System.Runtime.InteropServices.ProgId("clsLeg_NET.clsLeg")> Public Class clsLeg
	...
	Public Function LocationCheck() As Boolean
		...
		'user can not add more leg's to a form fitting battlesuit
		...
		If Veh.Options.BattleSuit = "Form Fitting" Then
			...
			If legcount > 2 Then
				TempCheck = False
				MsgBox("Form Fitting Battlesuits can't have more than 2 legs.")
		...
		If InstallPoint = Body Then
			TempCheck = True
		Else
			modHelper.InfoPrint(1, "Legs must be placed on hull.")
			TempCheck = False
		End If
