Option Strict Off
Option Explicit On
<System.Runtime.InteropServices.ProgId("clsHydrofoil_NET.clsHydrofoil")> Public Class clsHydrofoil
	...
	Public Function LocationCheck() As Boolean
		...
		If InstallPoint = Body Then
			TempCheck = True
		Else
			modHelper.InfoPrint(1, "Hydrofoil Subassembly must be placed on hull.")
			TempCheck = False
		End If
	...
	Public Sub StatsUpdate()
		'NOTE: No quantity needed in this sub.  I'm not allowing multiple hydros in one
		mvarZZInit = 1
		...
		'UPGRADE_WARNING: Couldn't resolve default property of object Veh.Components. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
		mvarVolume = System.Math.Round((Veh.Components(BODY_KEY).Volume * 0.15) + mvarAccessSpace, 2)
