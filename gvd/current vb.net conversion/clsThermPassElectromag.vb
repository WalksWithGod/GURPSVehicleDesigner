Option Strict Off
Option Explicit On
<System.Runtime.InteropServices.ProgId("clsThermPassElectromag_NET.clsThermPassElectromag")> Public Class clsThermPassElectromag
	...
	Public Sub GetMatrixIndex()
		...
		For i = 1 To UBound(ThermalPassiveIRMatrix)
			If ThermalPassiveIRMatrix(i).ID = mvarDatatype Then
				If ThermalPassiveIRMatrix(i).TL >= mvarTL Then
					mvarMatrixPos = i
					Exit For
				Else
					mvarMatrixPos = i
	...
	Public Sub StatsUpdate()
		...
		If mvarRange > 125 Then
			mvarCost = ThermalPassiveIRMatrix(mvarMatrixPos).Cost * (100 + (1 / 5 * mvarRange))
		Else
			mvarCost = mvarRange * ThermalPassiveIRMatrix(mvarMatrixPos).Cost
		End If
		
		'get base stats
		mvarWeight = (ThermalPassiveIRMatrix(mvarMatrixPos).Weight * mvarRange)
		mvarVolume = (mvarRange * ThermalPassiveIRMatrix(mvarMatrixPos).Volume)
		...
		mvarPowerReqt = ThermalPassiveIRMatrix(mvarMatrixPos).Power
