Option Strict Off
Option Explicit On
<System.Runtime.InteropServices.ProgId("clsPerformanceTrack_NET.clsPerformanceTrack")> Public Class clsPerformanceTrack
	...
	Public Sub CalcPerformance()
		...
		If mvarMotiveAssemblyKey = "" Then
			modHelper.InfoPrint(0, "No Track Subassembly detected on vehicle.  Cannot caclulate Tracked Ground performance.")
			Exit Sub
		Else
		...
		Call GetVehicleWeight(PERFORMANCETRACK, mvarPercentAuxVehicleWeight, mvarPercentCargoWeight, mvarPercentAmmunitionWeight, mvarPercentHardpointWeight, mvarPercentFuelWeight, mvarPercentProvisionWeight, m_VWeight, m_VMass)
	...
	Function CalcGroundSpeed() As Single
		...
		For i = 1 To UBound(mvarKeyChain)
			...
			If CDbl(dType) = TrackedDrivetrain Then
				'UPGRADE_WARNING: Couldn't resolve default property of object Veh.Components. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
