Option Strict Off
Option Explicit On
<System.Runtime.InteropServices.ProgId("clsStabilizationGear_NET.clsStabilizationGear")> Public Class clsStabilizationGear
	...
	Function LocationCheck() As Boolean
		...
		' Check for any component that has both a Weight and Volume
		...
		dblTemp = Veh.Components(mvarParent).Weight
		'UPGRADE_WARNING: Couldn't resolve default property of object Veh.Components. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
		dblTemp = Veh.Components(mvarParent).Volume
		'UPGRADE_WARNING: Couldn't resolve default property of object Veh.Components. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
		sTemp = Veh.Components(mvarParent).CustomDescription
		TempCheck = True
...
errorhandler: 
		...
		modHelper.InfoPrint(1, "Stablization gear can not be attached to this component.")
		LocationCheck = False
	End Function
	...
	Public Sub Init()
		...
		Select Case mvarDatatype
			Case FullStabilizationGear
				
			Case PartialStabilizationGear
	...
	Public Sub GetMatrixIndex()
		...
		For i = 1 To UBound(WeaponAccessoryMatrix)
			If WeaponAccessoryMatrix(i).ID = mvarDatatype Then
				If WeaponAccessoryMatrix(i).TL >= mvarTL Then
					mvarMatrixPos = i
					Exit For
				Else
					mvarMatrixPos = i
	...
	Public Sub StatsUpdate()
		...
		Dim ParentsWeight As Single
		Dim ParentsVolume As Single
		
		mvarLocation = GetLocation
		
		'UPGRADE_WARNING: Couldn't resolve default property of object Veh.Components. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
		ParentsWeight = Veh.Components(Parent).Weight
		'UPGRADE_WARNING: Couldn't resolve default property of object Veh.Components. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
		ParentsVolume = Veh.Components(Parent).Volume
		
		mvarWeight = System.Math.Round(WeaponAccessoryMatrix(mvarMatrixPos).Weight * ParentsWeight, 2)
		mvarCost = System.Math.Round(WeaponAccessoryMatrix(mvarMatrixPos).Cost * ParentsWeight, 2) 'yes ParentWeight and not ParentCost
		mvarVolume = System.Math.Round(WeaponAccessoryMatrix(mvarMatrixPos).Volume * ParentsVolume, 2)
		...
		'UPGRADE_WARNING: Couldn't resolve default property of object Veh.Components. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
		mvarPrintOutput = mvarCustomDescription & " for " & Veh.Components(mvarParent).CustomDescription & " (" & mvarLocation & ", HP " & mvarHitPoints & ", " & VB6.Format(mvarWeight, p_sFormat) & " lbs., " & VB6.Format(mvarVolume, p_sFormat) & " cf., " & "$" & VB6.Format(mvarCost, p_sFormat) & ")." & mvarComment
