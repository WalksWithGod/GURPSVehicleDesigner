Option Strict Off
Option Explicit On
<System.Runtime.InteropServices.ProgId("clsOtherSensor_NET.clsOtherSensor")> Public Class clsOtherSensor
	...
	Public Sub GetMatrixIndex()
		...
		For i = 1 To UBound(OtherSensorMatrix)
			If OtherSensorMatrix(i).ID = mvarDatatype Then
				If OtherSensorMatrix(i).TL >= mvarTL Then
					mvarMatrixPos = i
					Exit For
				Else
					mvarMatrixPos = i
	...
	Public Sub StatsUpdate()
		...
		'Cost Exception for Ranges greater than 25 miles
		If mvarRange > 25 Then
			mvarCost = CostMod * OtherSensorMatrix(mvarMatrixPos).Cost * (20 + (1 / 5 * mvarRange))
		Else
			mvarCost = CostMod * mvarRange * OtherSensorMatrix(mvarMatrixPos).Cost
		End If
		mvarWeight = OtherSensorMatrix(mvarMatrixPos).Weight * mvarRange
		mvarVolume = mvarRange * OtherSensorMatrix(mvarMatrixPos).Volume
		...
		mvarPowerReqt = OtherSensorMatrix(mvarMatrixPos).Power * mvarRange
