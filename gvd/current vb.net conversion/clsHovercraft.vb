Option Strict Off
Option Explicit On
<System.Runtime.InteropServices.ProgId("clsHovercraft_NET.clsHovercraft")> Public Class clsHovercraft
	...
	Public Function LocationCheck() As Boolean
		...
		If InstallPoint = Body Then
			TempCheck = True
		Else
			modHelper.InfoPrint(1, "Hovercraft Subassembly must be placed on hull.")
			TempCheck = False
		End If
	...
	Public Sub StatsUpdate()
		...
		'NOTE: No quantity allowed here either
