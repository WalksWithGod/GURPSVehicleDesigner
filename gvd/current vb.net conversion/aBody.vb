Option Strict Off
Option Explicit On
<System.Runtime.InteropServices.ProgId("aBody_NET.aBody")> Public Class aBody
	...
	Private m_lngDR As Integer 'todo: move DR back to cIComponent???
	...
	Private Property cIComponent_HitPoints() As Double Implements _cIComponent.HitPoints
		...
		End Set
	End Property
	Private ReadOnly Property cIContainer_ContainerAbbrev() As String Implements _cIContainer.ContainerAbbrev
		Get
		End Get
	End Property
	Private Property cIContainer_VolumeAccessSpace() As Double Implements _cIContainer.VolumeAccessSpace
		Get
		End Get
		Set(ByVal Value As Double)
		End Set
	End Property
	Private Property cIContainer_VolumeBattleSuit() As Double Implements _cIContainer.VolumeBattleSuit
		Get
		End Get
		Set(ByVal Value As Double)
		End Set
	End Property
	Private Property cIContainer_VolumeExtra() As Double Implements _cIContainer.VolumeExtra
		Get
...
err_Renamed: 
	...
	Private Function cIContainer_AcceptObject(ByRef oComponent As _cIComponent) As Integer Implements _cIContainer.AcceptObject
	End Function
